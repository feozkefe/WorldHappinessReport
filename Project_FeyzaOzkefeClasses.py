...
class WorldHappinessReport():
    ...
    def readAndPreprocessingDatasets(self):
        spark = self.spark
        # Load the Datasets
        df_2015 = spark.read.csv('ProjectData2015_FeyzaOzkefe.csv', sep=",", header=True)
        df_2016 = spark.read.csv('ProjectData2016_FeyzaOzkefe.csv', sep=",", header=True)
        df_2017 = spark.read.csv('ProjectData2017_FeyzaOzkefe.csv', sep=",", header=True)
        df_2018 = spark.read.csv('ProjectData2018_FeyzaOzkefe.csv', sep=",", header=True)
        df_2019 = spark.read.csv('ProjectData2019_FeyzaOzkefe.csv', sep=",", header=True)
        df_2020 = spark.read.csv('ProjectData2020_FeyzaOzkefe.csv', sep=",", header=True)
        df_2021 = spark.read.csv("ProjectData2021_FeyzaOzkefe.csv", sep=",", header=True)
